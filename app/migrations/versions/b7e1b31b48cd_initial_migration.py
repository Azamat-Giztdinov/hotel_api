...
Revision ID: b7e1b31b48cd
Revises: 
Create Date: 2024-09-26 12:41:54.758876
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('horel_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    sa.Column('image_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['horel_id'], ['hotels.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
